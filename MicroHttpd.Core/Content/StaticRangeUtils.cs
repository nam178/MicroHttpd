...
namespace MicroHttpd.Core.Content
{
	static class StaticRangeUtils
    {
		...
		public static void RequireValidRangeWithin(
		...
		public static string GenerateRangeHeaderKeyAndValue(this StaticRangeRequest rangeRequest, long length)
		{
			return $"{HttpKeys.ContentRange}: {GenerateRangeHeaderValue(rangeRequest, length)}";
		}

		public static string GenerateRangeHeaderValue(this StaticRangeRequest range, long length)
